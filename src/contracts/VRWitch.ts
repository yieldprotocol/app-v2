...
export interface VRWitchInterface extends utils.Interface {
  functions: {
...
export interface VRWitch extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VRWitchInterface;
  ...
  callStatic: {
    ...
    auction(
      ...
      [DataTypes.AuctionStructOutput, VRDataTypes.VaultStructOutput] & {
        auction_: DataTypes.AuctionStructOutput;
        vault: VRDataTypes.VaultStructOutput;
      }
    >;
