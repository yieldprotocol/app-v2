...
interface ChainlinkUSDOracleInterface extends ethers.utils.Interface {
  functions: {
...
export type SourceSetEvent = TypedEvent<
  [string, string, string] & { baseId: string; base: string; source: string }
>;

export class ChainlinkUSDOracle extends BaseContract {
  ...
  interface: ChainlinkUSDOracleInterface;
