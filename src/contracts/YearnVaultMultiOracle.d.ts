...
interface YearnVaultMultiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YearnVaultMultiOracle extends BaseContract {
  ...
  filters: {
    ...
    "SourceSet(bytes6,bytes6,address,uint8)"(
      ...
      [string, string, string, number],
      { baseId: string; quoteId: string; source: string; decimals: number }
    >;
