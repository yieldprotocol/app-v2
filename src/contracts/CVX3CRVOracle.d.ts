...
interface CVX3CRVOracleInterface extends ethers.utils.Interface {
  functions: {
    ...
    "cvx3CrvId()": FunctionFragment;
    "ethId()": FunctionFragment;
    ...
    "setSource(bytes32,bytes32,address,address,address,address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "cvx3CrvId", values?: undefined): string;
  encodeFunctionData(functionFragment: "ethId", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "cvx3CrvId", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "ethId", data: BytesLike): Result;
  ...
  events: {
    ...
    "SourceSet(bytes32,bytes32,address,address,address,address)": EventFragment;
  };
...
export class CVX3CRVOracle extends BaseContract {
  ...
  interface: CVX3CRVOracleInterface;
  ...
  functions: {
    ...
    cvx3CrvId(overrides?: CallOverrides): Promise<[string]>;

    ethId(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "SourceSet(bytes32,bytes32,address,address,address,address)"(
      cvx3CrvId_?: null,
      ethId_?: null,
      threecrv_?: null,
      DAI_?: null,
  ...
  estimateGas: {
    ...
    cvx3CrvId(overrides?: CallOverrides): Promise<BigNumber>;

    ethId(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    cvx3CrvId(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    ethId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
