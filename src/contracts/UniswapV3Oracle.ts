...
export interface SecondsAgoSetEventObject {
  secondsAgo: number;
}
export type SecondsAgoSetEvent = TypedEvent<[number], SecondsAgoSetEventObject>;

export type SecondsAgoSetEventFilter = TypedEventFilter<SecondsAgoSetEvent>;
...
export interface UniswapV3Oracle extends BaseContract {
  ...
  functions: {
    ...
    setSecondsAgo(
      secondsAgo_: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "SecondsAgoSet(uint32)"(
      secondsAgo?: PromiseOrValue<BigNumberish> | null
    ): SecondsAgoSetEventFilter;
    SecondsAgoSet(
      secondsAgo?: PromiseOrValue<BigNumberish> | null
    ): SecondsAgoSetEventFilter;

    "SourceSet(bytes6,bytes6,address)"(
      base?: PromiseOrValue<BytesLike> | null,
      quote?: PromiseOrValue<BytesLike> | null,
