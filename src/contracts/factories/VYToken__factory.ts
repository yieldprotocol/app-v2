...
export class VYToken__factory {
  ...
  static createInterface(): VYTokenInterface {
    return new utils.Interface(_abi) as VYTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VYToken {
    return new Contract(address, _abi, signerOrProvider) as VYToken;
  }
}
