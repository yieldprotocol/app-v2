...
import type { WitchV2, WitchV2Interface } from "../WitchV2";
...
export class WitchV2__factory {
  static readonly abi = _abi;
  static createInterface(): WitchV2Interface {
    return new utils.Interface(_abi) as WitchV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WitchV2 {
    return new Contract(address, _abi, signerOrProvider) as WitchV2;
  }
}
