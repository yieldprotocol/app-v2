...
import type { StrategyV2, StrategyV2Interface } from "../StrategyV2";
...
export class StrategyV2__factory {
  ...
  static createInterface(): StrategyV2Interface {
    return new utils.Interface(_abi) as StrategyV2Interface;
  }
  static connect(
    address: string,
