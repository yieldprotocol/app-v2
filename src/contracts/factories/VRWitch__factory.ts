...
export class VRWitch__factory {
  ...
  static createInterface(): VRWitchInterface {
    return new utils.Interface(_abi) as VRWitchInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VRWitch {
    return new Contract(address, _abi, signerOrProvider) as VRWitch;
  }
}
