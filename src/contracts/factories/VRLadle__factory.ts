...
export class VRLadle__factory {
  ...
  static createInterface(): VRLadleInterface {
    return new utils.Interface(_abi) as VRLadleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VRLadle {
    return new Contract(address, _abi, signerOrProvider) as VRLadle;
  }
}
