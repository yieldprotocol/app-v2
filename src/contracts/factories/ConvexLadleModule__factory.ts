...
export class ConvexLadleModule__factory {
  ...
  static createInterface(): ConvexLadleModuleInterface {
    return new utils.Interface(_abi) as ConvexLadleModuleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ConvexLadleModule {
    return new Contract(address, _abi, signerOrProvider) as ConvexLadleModule;
  }
}
