...
export interface ConvexLadleModuleInterface extends utils.Interface {
  functions: {
    "addVault(address,bytes12)": FunctionFragment;
    ...
    "removeVault(address,bytes12,address)": FunctionFragment;
...
export interface ConvexLadleModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConvexLadleModuleInterface;
  ...
  functions: {
    addVault(
      convexJoin: PromiseOrValue<string>,
