...
export interface NotionalMultiOracleInterface extends utils.Interface {
  functions: {
...
export interface NotionalMultiOracle extends BaseContract {
  ...
  functions: {
    ...
    setSource(
      notionalId: PromiseOrValue<BytesLike>,
  ...
  filters: {
    ...
    "SourceSet(bytes6,bytes6,address)"(
      notionalId?: PromiseOrValue<BytesLike> | null,
      underlyingId?: PromiseOrValue<BytesLike> | null,
      underlying?: null
