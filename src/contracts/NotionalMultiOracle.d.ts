...
interface NotionalMultiOracleInterface extends ethers.utils.Interface {
  functions: {
    "FCASH_DECIMALS()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "FCASH_DECIMALS",
    values?: undefined
  ): string;
...
export class NotionalMultiOracle extends BaseContract {
  ...
  interface: NotionalMultiOracleInterface;

  functions: {
    FCASH_DECIMALS(overrides?: CallOverrides): Promise<[number]>;
    ...
    setSource(
      notionalId: BytesLike,
      underlyingId: BytesLike,
      underlying: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "SourceSet(bytes6,bytes6,address)"(
      notionalId?: BytesLike | null,
      underlyingId?: BytesLike | null,
      underlying?: null
    ): TypedEventFilter<
      [string, string, string],
      { notionalId: string; underlyingId: string; underlying: string }
    >;
  ...
  estimateGas: {
    FCASH_DECIMALS(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    FCASH_DECIMALS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
