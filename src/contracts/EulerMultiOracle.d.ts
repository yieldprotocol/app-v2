...
interface EulerMultiOracleInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "SourceSet(bytes6,bytes6,address,bool)": EventFragment;
  };
...
export class EulerMultiOracle extends BaseContract {
  ...
  interface: EulerMultiOracleInterface;
  ...
  filters: {
    ...
    "SourceSet(bytes6,bytes6,address,bool)"(
      ...
      [string, string, string, boolean],
      { baseId: string; quoteId: string; source: string; inverse: boolean }
    >;
