...
export class ChainlinkAggregatorV3Mock extends BaseContract {
  ...
  set(price_: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    set(price_: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
