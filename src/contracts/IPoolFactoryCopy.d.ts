...
interface IPoolFactoryCopyInterface extends ethers.utils.Interface {
  functions: {
...
export class IPoolFactoryCopy extends BaseContract {
  ...
  interface: IPoolFactoryCopyInterface;
