...
export class IFYToken extends BaseContract {
  ...
  callStatic: {
    ...
    burn(from: string, fyTokenAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;

    mature(overrides?: CallOverrides): Promise<void>;

    maturity(overrides?: CallOverrides): Promise<BigNumber>;

    mint(to: string, fyTokenAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
