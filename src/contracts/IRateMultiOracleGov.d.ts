...
interface IRateMultiOracleGovInterface extends ethers.utils.Interface {
  functions: {
...
export class IRateMultiOracleGov extends BaseContract {
  ...
  interface: IRateMultiOracleGovInterface;
