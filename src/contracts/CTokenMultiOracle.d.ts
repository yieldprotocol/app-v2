...
interface CTokenMultiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export type SourceSetEvent = TypedEvent<
  [string, string, string] & { baseId: string; quoteId: string; cToken: string }
>;

export class CTokenMultiOracle extends BaseContract {
  ...
  interface: CTokenMultiOracleInterface;
  ...
  filters: {
    ...
    "SourceSet(bytes6,bytes6,address)"(
      ...
      [string, string, string],
      { baseId: string; quoteId: string; cToken: string }
    >;
