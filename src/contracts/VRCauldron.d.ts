...
interface VRCauldronInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "addBase", values: [BytesLike]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "bases", values: [BytesLike]): string;
  encodeFunctionData(
...
export type BaseAddedEvent = TypedEvent<[string] & { baseId: string }>;
...
export type IlkAddedEvent = TypedEvent<
  [string, string] & { baseId: string; ilkId: string }
>;
...
export type VaultTweakedEvent = TypedEvent<
  [string, string, string] & { vaultId: string; baseId: string; ilkId: string }
>;

export class VRCauldron extends BaseContract {
  ...
  functions: {
    ...
    bases(arg0: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    addBase(baseId: BytesLike, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    ): TypedEventFilter<[string], { baseId: string }>;
    ...
    "IlkAdded(bytes6,bytes6)"(
      baseId?: BytesLike | null,
      ilkId?: BytesLike | null
    ): TypedEventFilter<[string, string], { baseId: string; ilkId: string }>;
    ...
    "VaultBuilt(bytes12,address,bytes6,bytes6)"(
      ...
      [string, string, string, string],
      { vaultId: string; owner: string; baseId: string; ilkId: string }
    >;
    ...
    "VaultTweaked(bytes12,bytes6,bytes6)"(
      ...
      [string, string, string],
      { vaultId: string; baseId: string; ilkId: string }
    >;
  ...
  estimateGas: {
    ...
    bases(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
