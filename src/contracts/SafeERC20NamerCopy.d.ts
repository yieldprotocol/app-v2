...
interface SafeERC20NamerCopyInterface extends ethers.utils.Interface {
  functions: {
...
export class SafeERC20NamerCopy extends BaseContract {
  ...
  interface: SafeERC20NamerCopyInterface;
