...
interface AuthGemJoinAbstractInterface extends ethers.utils.Interface {
  functions: {
...
export class AuthGemJoinAbstract extends BaseContract {
  ...
  interface: AuthGemJoinAbstractInterface;
