...
interface CompoundChiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundChiOracle extends BaseContract {
  ...
  interface: CompoundChiOracleInterface;
