  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="80%" height="80%" viewBox="0 0 1000 1000" fill="none" {...props}>
      <g data-name="Layer 1">
        ...
        <path
          fill="#fff"
          d="M630.1 758.9c-25.6 38.9-74.9 75.6-159.8 69.4-42.8-2.9-145.8-58-126.4-179.7 3.4-22.8 16.1-52.9 16.1-52.9l-57.7 11.2-11.3-45.5L431.9 528l27.4 146-41.9 8.3-14.6-69.3s-39.4 60.9 9.2 126.5c28.8 33.8 42.8 35.5 76.1 41.6 29.1 5 97.5-3.2 119.9-82.1 9.9-50.9 1.2-89.1-63.4-140.5l5.2-55.1s72.3 53.8 90.3 90.7c13.8 29.3 37.5 86.9-10 164.8z"
          data-name="SVGID"
        />
      </g>
    </svg>
