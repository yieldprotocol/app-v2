    ...
    <>
      {allowSupport ? (
        <Box gap="large">
          ...
          <Box gap="small">
            <Box direction="row" justify="between">
              <Text color="text" weight={'bolder'} size="small">
                Force Transactions
              </Text>
              <Switch
                width={55}
        ...
        <Box pad="small" gap="small">
          ...
          <Text size="xsmall">
            Please ensure you are connected with a recognised support wallet. Contact the development team if you
            believe you require access.
          </Text>
        </Box>
      )}
    </>
