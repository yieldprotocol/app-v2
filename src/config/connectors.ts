...
export const INIT_INJECTED =
  localStorage.getItem('connectionName') !== null || localStorage.getItem('connectionName') !== 'undefined'
    ? (JSON.parse(localStorage.getItem('connectionName')!) as string)
    : 'metamask';
