import { WETH, DAI, USDC, WBTC, stETH, wstETH, ENS, LINK, UNI, yvUSDC, MKR, FUSDC0622, FDAI0622 } from './assets';
...
/* notional additions */
usdcIlkOracle1.set(FUSDC0622, NOTIONAL_MULTI_ORACLE);
...
/* notional additions */
daiIlkOracle1.set(FDAI0622, NOTIONAL_MULTI_ORACLE);
