...
ethIlkOracle421611.set(ENS, CHAINLINK_USD_ORACLE);
ethIlkOracle421611.set(LINK, CHAINLINK_USD_ORACLE);
ethIlkOracle421611.set(UNI, CHAINLINK_USD_ORACLE);
ethIlkOracle421611.set(yvUSDC, YEARNVAULT_MULTI_ORACLE);
ethIlkOracle421611.set(MKR, CHAINLINK_USD_ORACLE);
