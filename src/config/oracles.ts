...
// ETH base
const wethIlkOracle421611 = new Map<string, string>();
wethIlkOracle421611.set(WETH, CHAINLINK_USD_ORACLE);
wethIlkOracle421611.set(DAI, CHAINLINK_USD_ORACLE);
wethIlkOracle421611.set(USDC, CHAINLINK_USD_ORACLE);

wethIlkOracle421611.set(RATE, ACCUMULATOR_MULTI_ORACLE);

CHAIN_ID_421611_ASSET_ORACLE_INFO.set(WETH, wethIlkOracle421611);
