...
const HistoryProvider = ({ children }: any) => {
  ...
  const updateTradeHistory = useCallback(
    ...
    [account, assetRootMap, contracts, diagnostics, provider]
  );
  ...
  const updateVaultHistory = useCallback(
    ...
    [_parseGivenLogs, _parsePourLogs, _parseRolledLogs, contracts, diagnostics, seriesRootMap]
  );
