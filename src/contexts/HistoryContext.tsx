  ...
  const updateStrategyHistory = useCallback(
    async (strategyList: IStrategy[]) => {
      ...
      try {
        ...
        console.log('error getting strategy history');
        updateState({ type: 'errors', payload: { type: 'strategy', message: 'Error getting strategy history' } });
      }
    },
  ...
  const updatePoolHistory = useCallback(
    async (seriesList: ISeries[]) => {
      try {
        ...
        console.log('error getting pool history');
  ...
  const updateTradeHistory = useCallback(
    async (seriesList: ISeries[]) => {
      try {
        ...
        console.log('error getting trade history');
        updateState({ type: 'errors', payload: { type: 'trade', message: 'Error getting trade history' } });
      }
    },
  ...
  const updateVaultHistory = useCallback(
    async (vaultList: IVault[]) => {
      try {
        ...
        console.log('error getting vault history');
